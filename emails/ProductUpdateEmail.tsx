...
export const ProductUpdateEmail: React.FC = () => (
  <Html>
    <Head />
    <Preview>New updates for LearnifyTube!</Preview>
    <Body style={main}>
      <Container style={container}>
        <Img
          ...
          style={logo}
        />
        <Heading style={h1}>New Updates for LearnifyTube</Heading>
        <Text style={p}>
          We&apos;re excited to announce some new updates to LearnifyTube! Our team
        ...
        <Text style={p}>
          ...
          <a href="mailto:support@learnifytube.com">support@learnifytube.com</a>.
        </Text>
      </Container>
    </Body>
  </Html>
