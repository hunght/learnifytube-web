...
export default function Home() {
  ...
  const productRepoUrl = siteConfig.links.github;
    ...
    <>
      ...
      <JsonLd<VideoObject>
        item={{
          ...
          description:
            'Watch how LearnifyTube helps you learn languages from videos',
      ...
      <div className="min-h-dvh relative flex flex-col bg-background">
        ...
        <main className="flex-1">
          {/* Hero Section */}
          <section
            className="hero-section py-12 md:py-20"
            ...
            <div className="container mx-auto px-4">
              <div className="text-center">
                ...
                <p className="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground md:text-xl">
                  The offline video player built for language learners. Dual
                  subtitles, instant translation, flashcards with spaced
                  repetition, and AI-powered study tools.
                </p>

                {/* CTA Buttons */}
                <div className="mb-6 flex flex-col items-center justify-center gap-4 sm:flex-row">
                  <DownloadButton />
                  <AndroidDownloadButton className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-6 py-3 text-sm font-semibold text-emerald-700 shadow-sm transition hover:bg-emerald-100 disabled:opacity-70 dark:border-emerald-700/60 dark:bg-emerald-900/20 dark:text-emerald-200 dark:hover:bg-emerald-900/30" />
                  <GitHubButton
                    href={productRepoUrl}
                    type="star"
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="mb-12 text-center">
                ...
                <p className="mx-auto mt-4 max-w-2xl text-slate-400">
                  Compared against Language Reactor, LLPlayer, and Knowclip –
                  LearnifyTube covers 80% of essential language learning
                  features, plus extras they don&apos;t have.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                {features.map((feature, index) => (
                  ...
                  >
                    <div
                      className={`mb-4 inline-flex rounded-lg ${feature.color} p-3 text-white`}
                    >
                      {feature.icon}
                    </div>
            ...
            <div className="container mx-auto px-4">
              <div className="mb-10 text-center">
                ...
                <p className="mx-auto max-w-3xl text-lg text-muted-foreground">
                  Your learning data stays on your device. No accounts, no cloud
                  sync, no tracking. LearnifyTube is 100% open source and
                  community-driven.
                </p>
              </div>
              ...
              <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-3">
                <Card className="flex flex-col items-center p-6 text-center">
                  ...
                  <CardHeader className="p-0">
                    ...
                    <CardDescription>
                      Help us build the best language learning video player.
                      Code, ideas, and feedback welcome.
                    </CardDescription>
                  </CardHeader>
                ...
                <Card className="flex flex-col items-center p-6 text-center">
                  ...
                  <CardHeader className="p-0">
                    ...
                    <CardDescription>
                      Learn about all features, keyboard shortcuts, and how to
                      get the most out of LearnifyTube.
                    </CardDescription>
                  </CardHeader>
                  <div className="mt-auto pt-4">
                    <a
                      href={`${productRepoUrl}#readme`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center text-sm font-medium text-primary hover:underline"
                    >
                ...
                <Card className="flex flex-col items-center p-6 text-center">
                  ...
                  <CardHeader className="p-0">
                    ...
                    <CardDescription>
                      Join language learners and developers. Share tips, request
                      features, get help.
                    </CardDescription>
                  </CardHeader>
                  <div className="mt-auto pt-4">
              ...
              <div className="mt-12 text-center">
                <div className="mb-4 inline-flex items-center justify-center space-x-2">
                  <GitHubButton
                    href={`${productRepoUrl}/stargazers`}
                    type="star"
          ...
          {/* CTA Section */}
          <section
            className="cta-section bg-gradient-to-r from-blue-600 to-green-600 py-16"
          ...
          >
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="mb-8 text-lg text-white/80">
                Join thousands of language learners using LearnifyTube for
                immersive, offline video learning.
              </p>
              <DownloadNowButton
                size="lg"
